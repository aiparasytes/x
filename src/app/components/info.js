export default function Info() {
    return (
      <div className="container max-w-5xl mx-auto  p-8 ">
        ...
        <div className=" backdrop-blur-lg text-center px-4 text-white pb-8 pt-8 rounded-md drop-shadow-lg  ">
          <p className="text-md md:text-2xl text-justify ">
              <span className="text-gray-400">AI</span>Parasytes refleja la idea central del proyecto: la IA como un ente que consume,
