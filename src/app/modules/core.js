  ...
  return (
    <div style={{ position: "relative", width: "100%", height: "1000px" }}>
      ...
      <div className="absolute inset-0 flex items-center justify-center p-6 ">
        <div className="bg-black/30 backdrop-blur-xs text-white max-w-7xl p-8 rounded-2xl drop-shadow-lg text-center">
          <h1 className="text-lg md:text-5xl font-bold mb-6 text-green-500 shadow-lg rounded-3xl bg-black/20">AI Parasytes</h1>
